...
<textarea type="text" cols="130" rows="10" name="codert" class="codert area-1 resize-vertical" id="codert" placeholder="код сервис"/>{eventclick}input;id;nomer_test;click{/eventclick}{eventclick}input;value;Голосовать;click{/eventclick}</textarea>
...
<label for="urlvhoda">URL голосования</label>
...
http://napishute_zdes_ssilky_golosovaniya.ru
</textarea><br />
<ol>
...
<div id="block1">
<div id="bl">
Использовать на <input type="number" id="procent-1" name="procent-1" value="50" min="0" max="100" step="1"> % от общего кол-ва (от 0 до 100)<br />
...
http://vk.com/public77088121
http://vk.com/public50512447
http://vk.com/prizevk
http://vk.com/zaberiprizi
http://vk.com/club8830886
...
<div id="block2">
<div id="bl">
Использовать на <input type="number" name="procent-2" id="procent-2" value="50" min="0" max="100" step="1"> от общего кол-ва % (от 0 до 100)<br />
...
<textarea type="text" class="area-3 resize-vertical" cols="60" rows="16" name="zaprospoisk" id="zaprospoisk" placeholder="Ключевые запросы, каждый с новой строки. Для использования "закладок" поставьте галочку у поисковиков"/>голосования
призы и конкурсы
онлайн голосования
призы в голосованиях
популярные конкурсы
